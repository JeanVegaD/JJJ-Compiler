  ...
  def main(args: Array[String]): Unit = {
    ...
    val collateralAgreementAsset = Seq(
      ("ZERO_AGREEMENT","ZERO_ASSET","2019-03-17","2019-04-17","2020-01-01",333.33),
        ...
        ("NOT_MATCHING_DATE","NOT_MATCHING_DATE","2020-10-10","2020-10-10",null,1000.00)
    ).toDF("COLLATERAL_AGREEMENT_ID","COLLATERAL_ASSET_ID","COLLATERAL_ASSET_START_DATETIME","COLLATERAL_AGREEMENT_START_DATETIME","COLLATERAL_AGREEMENT_ASSET_END_DATETIME","ALLOCATED_AGREEMENT_ASSET_REPORTING_AMOUNT")
    collateralAgreementAsset.show()

    project(
      collateralAsset
      , collateralAgreement
      , collateralAgreementAsset
    ).show()
  }
